...
(function (Semesteraufgabe1) {
    ...
    function skiPiste() {
        ...
        //Verziehrung 
        Semesteraufgabe1.crc2.fillStyle = "#6A3F16";
        Semesteraufgabe1.crc2.fillRect(150, 400, 50, 500);
        Semesteraufgabe1.crc2.fillStyle = "#6A3F16";
        Semesteraufgabe1.crc2.fillRect(300, 400, 50, 500);
        Semesteraufgabe1.crc2.fillStyle = "#6A3F16";
        Semesteraufgabe1.crc2.fillRect(450, 400, 50, 500);
        Semesteraufgabe1.crc2.fillStyle = "#6A3F16";
        Semesteraufgabe1.crc2.fillRect(600, 400, 50, 500);
        //Boden
