...
(function (Semesteraufgabe1) {
    ...
    function skiPiste() {
        ...
        //Arm
        Semesteraufgabe1.crc2.fillStyle = "#ADACAB";
        Semesteraufgabe1.crc2.fillRect(320, 260, 20, 50);
        Semesteraufgabe1.crc2.fillStyle = "#0F0F0F";
        Semesteraufgabe1.crc2.fillRect(321, 261, 20, 50);
        Semesteraufgabe1.crc2.fillStyle = "#ADACAB"; //Unterarm
        Semesteraufgabe1.crc2.fillRect(340, 260, 50, 20);
        Semesteraufgabe1.crc2.fillStyle = "#0F0F0F";
        Semesteraufgabe1.crc2.fillRect(341, 261, 50, 20);
